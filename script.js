...
function showContent(page) {
    ...
    if (page === 'results') {
        ...
        favoritessNav.classList.remove('hidden'); 
    }
...
function createDOMNodes(page) {
    ...
    currentArray.forEach((result) => {
        ...
        // Card Infos Footer with Date and Copyright (if exists)
        const cardInfos = document.createElement('small');
        cardInfos.classList.add('text-muted');
        // Card Date
        ...
        // Append Elements
        cardInfos.append(cardDate, cardCopyright);
        cardBody.append(cardTitle, saveText, cardText, cardInfos);
